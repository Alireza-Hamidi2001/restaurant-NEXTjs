    ...
    return (
        <div className="relative bg-black/10 backdrop-blur-xl min-h-screen flex items-center justify-center px-4 py-12 overflow-hidden">
            <div
                ...
                className="absolute animate-bounce bottom-25 w-24 h-24 bg-red-400/20 rounded-full"></div>
            <div
                style={{
                    animationDuration: "1.2s",
                }}
                className="absolute animate-bounce top-25 translate-x-16 w-32 h-32 bg-red-400/10 rounded-full"></div>
